...
- [AWS MCP Servers](#aws-mcp-servers)
  ...
  - [Available Servers](#available-servers)
    ...
    - [AWS DocumentDB MCP Server](#aws-documentdb-mcp-server)
...
A server for interacting with AWS DocumentDB clusters, Amazon's MongoDB-compatible document database service.
...
- [AWS DocumentDB MCP Server](https://awslabs.github.io/mcp/servers/documentdb-mcp-server/)
